...
if client:
    ...
    directiveForce=db["questions_1_DirectiveForce"]
    memory=db["questions_2_Memory"]
    attention=db["questions_3_Attention"]
    Recollection=db["questions_4_Recollection"]
    language=db["questions_5_language"]
    ExecutiveCapacity=db["questions_6_ExecutiveCapacity"]
    CommonSense=db["questions_7_CommonSense"]
